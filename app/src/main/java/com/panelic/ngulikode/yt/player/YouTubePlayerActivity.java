...
package com.panelic.ngulikode.yt.player;
...
public class YouTubePlayerActivity extends YouTubeBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //	startActivity(new Intent(Intent.ACTION_VIEW,Uri.parse("http://www.youtube.com/watch?v=" + getIntent().getStringExtra(EXTRA_VIDEO_ID))));
        //} else {
