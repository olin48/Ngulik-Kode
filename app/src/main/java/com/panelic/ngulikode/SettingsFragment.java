...
import com.panelic.ngulikode.billing.BillingProcessor;
import com.panelic.ngulikode.billing.TransactionDetails;
...
public class SettingsFragment extends PreferenceFragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String extra = getArguments().getString(MainActivity.DATA);
		if (null != extra && extra.equals(SHOW_DIALOG)){
